...
module.exports = function init(Blockly) {
  ...
  Blockly.Msg["ADD_COMMENT"] = "Voeg Reactie toe";
  Blockly.Msg["CANNOT_DELETE_VARIABLE_PROCEDURE"] =
    "Kan niet de variabel '%1' verwijderen omdat het een onderdeel is van de definitie van de functie '%2'";
  Blockly.Msg["CHANGE_VALUE_TITLE"] = "Verander waarde:";
  Blockly.Msg["CLEAN_UP"] = "Blokken schoonmaken";
  Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] = "Samengevouwen blokken bevat waarschuwingen.";
  ...
  Blockly.Msg["COLOUR_BLEND_TOOLTIP"] = "Meng 2 kleuren samen met een gegeven verhouding (0.0 - 1.0).";
  ...
  Blockly.Msg["COLOUR_RANDOM_TOOLTIP"] = "Kies een kleur op willekeurig.";
  ...
  Blockly.Msg["COLOUR_RGB_TOOLTIP"] =
    "Maak een kleur met de specifieke aantal van rood, groen, en blauw. Alle waardes moeten zijn tussen 0 en 100.";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_HELPURL"] =
    "https://github.com/google/blockly/wiki/Loops#loop-termination-blocks";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK"] = "breek uit de loop";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE"] = "doorgaan met volgende herhaling van de loop";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK"] = "Breek uit de bevattende loop.";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE"] =
    "Sla de rest van de loop over, en ga verder met de volgende herhaling.";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_WARNING"] = "Waarschuwing: Dit blok kan alleen gebruikt worden zonder een loop.";
  Blockly.Msg["CONTROLS_FOREACH_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#for-each";
  Blockly.Msg["CONTROLS_FOREACH_TITLE"] = "voor elk item %1 in lijst %2";
  Blockly.Msg["CONTROLS_FOREACH_TOOLTIP"] =
    "Voor elk item in een lijst, zet de variabel '%1' naar het item, en dan doe een paar verklaringen.";
  Blockly.Msg["CONTROLS_FOR_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#count-with";
  Blockly.Msg["CONTROLS_FOR_TITLE"] = "tel met %1 van %2 naar %3 bij %4";
  Blockly.Msg["CONTROLS_FOR_TOOLTIP"] =
    "Laat de variabele '%1' de waarden aannemen van het startnummer tot het eindnummer, tel met het opgegeven interval, en voer de opgegeven blokken uit.";
  Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] = "Voeg een conditie toe aan het als blok.";
  Blockly.Msg["CONTROLS_IF_ELSE_TOOLTIP"] = "Voeg een einde toe, haal-alle conditie naar de als blok.";
  Blockly.Msg["CONTROLS_IF_HELPURL"] = "https://github.com/google/blockly/wiki/IfElse";
  Blockly.Msg["CONTROLS_IF_IF_TOOLTIP"] = "Voeg toe, verwijder, of herorganiseer secties naar herconfiguratie deze als blok.";
  Blockly.Msg["CONTROLS_IF_MSG_ELSE"] = "dan";
  Blockly.Msg["CONTROLS_IF_MSG_ELSEIF"] = "dan als";
  Blockly.Msg["CONTROLS_IF_MSG_IF"] = "als";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_1"] = "Als een waarde is waar, dan doe een paar verklaringen.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_2"] =
    "Als een waarde is waar, dan doe de eerste blok van verklaringen. Anders, doe de tweede blok van condities.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_3"] =
    "Als de eerste waarde waar is, dan doe de eerste blok van condities. Anders, als de tweede waarde is waar, doe de tweede blok van condities.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_4"] =
    "Als de eerste waarde is waar, dan doe de eerste blok van condities. Anders, als de tweede waarde is waar, doe de tweede blok van condities. Als geen van de waardes waas zijn, doe de laaste blok van condities.";
  Blockly.Msg["CONTROLS_REPEAT_HELPURL"] = "https://en.wikipedia.org/wiki/For_loop";
  Blockly.Msg["CONTROLS_REPEAT_INPUT_DO"] = "doe";
  Blockly.Msg["CONTROLS_REPEAT_TITLE"] = "herhaal %1 keer";
  Blockly.Msg["CONTROLS_REPEAT_TOOLTIP"] = "Doe een paar condities paar keer.";
  ...
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] = "Terwijl een waarde is niet waar, dan doe een paar condities.";
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] = "Terwijl een waarde is waar, dan doe een paar condities.";
  Blockly.Msg["DELETE_ALL_BLOCKS"] = "Verwijder alle %1 blokken?";
  Blockly.Msg["DELETE_BLOCK"] = "Verwijder Blok";
  Blockly.Msg["DELETE_VARIABLE"] = "Verwijder de '%1' variabel";
  Blockly.Msg["DELETE_VARIABLE_CONFIRMATION"] = "Verwijder %1 gebruiken van de '%2' variabel?";
  Blockly.Msg["DELETE_X_BLOCKS"] = "Verwijder %1 Blockken";
  Blockly.Msg["DIALOG_CANCEL"] = "Annuleer";
  Blockly.Msg["DIALOG_OK"] = "OK";
  Blockly.Msg["DISABLE_BLOCK"] = "Blok uitschakelen";
  Blockly.Msg["DUPLICATE_BLOCK"] = "Dupliceren";
  Blockly.Msg["DUPLICATE_COMMENT"] = "Dupliceer Reactie";
  Blockly.Msg["ENABLE_BLOCK"] = "Blok Activeren";
  Blockly.Msg["EXPAND_ALL"] = "Blokken Uitbereiden";
  Blockly.Msg["EXPAND_BLOCK"] = "Blok uitbereiden";
  Blockly.Msg["EXTERNAL_INPUTS"] = "Externe Inputs";
  Blockly.Msg["HELP"] = "Help";
  Blockly.Msg["INLINE_INPUTS"] = "In lijn Inputs";
  Blockly.Msg["LISTS_CREATE_EMPTY_HELPURL"] = "https://github.com/google/blockly/wiki/Lists#create-empty-list";
  Blockly.Msg["LISTS_CREATE_EMPTY_TITLE"] = "maak lege lijst";
